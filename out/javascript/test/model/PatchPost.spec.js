...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlogPostsApi.PatchPost();
  });
  ...
  describe('PatchPost', function() {
    it('should create an instance of PatchPost', function() {
      // uncomment below and update the code to test PatchPost
      //var instane = new BlogPostsApi.PatchPost();
      //expect(instance).to.be.a(BlogPostsApi.PatchPost);
    });
