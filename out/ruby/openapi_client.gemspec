...
Gem::Specification.new do |s|
  ...
  s.email       = ["amirm.lavasani@gmail.com"]
  s.homepage    = "https://openapi-generator.tech"
  s.summary     = "Blog Posts API Ruby Gem"
  s.description = "This is an example API for blog posts using OpenApi Specification. --- Using this API you can retrieve blog posts, comments on each blog post and delete or update the posts. "
  s.license     = "Unlicense"
