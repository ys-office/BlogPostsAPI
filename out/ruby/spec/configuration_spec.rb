...
describe OpenapiClient::Configuration do
  ...
  before(:each) do
    ...
    # require 'URI'
    # uri = URI.parse("https://virtserver.swaggerhub.com/ys-office-me/harmony-for-job-tree-japan/1.0.0")
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://virtserver.swaggerhub.com/ys-office-me/harmony-for-job-tree-japan/1.0.0")
    end
